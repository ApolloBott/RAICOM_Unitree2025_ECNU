...
# -*- coding: utf-8 -*-
"""
增强版的 Run_crossing2.py，具有健壮的串口连接管理
"""
...
if __name__ == "__main__":
    ...
    if not validate_serial_connections(serial_connections):
        print("[ERROR] Some serial connections failed. The program will continue but some functions may not work properly.")
