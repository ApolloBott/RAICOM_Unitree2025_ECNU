...
if __name__ == "__main__":
    ...
    armcontrol.reset_arm(125, 775, 0, 150, 500, 0,ser2)
    ...
    while True:  
        ...
        if actions.sm == 's_start':
            actions.f_start(img_processor,sport_client,armcontrol)
            #actions.f_start(img_processor,sport_client)
        elif actions.sm == 's_in_circle':
            actions.f_in_circle(img_processor,sport_client,armcontrol,ser1,ser2)
